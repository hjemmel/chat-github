...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'UserLinks.link'
        db.alter_column('chat_userlinks', 'link_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['chat.Links'], unique=True))
        # Adding unique constraint on 'UserLinks', fields ['link']
        db.create_unique('chat_userlinks', ['link_id'])

        # Changing field 'UserLinks.user'
        db.alter_column('chat_userlinks', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True))
        # Adding unique constraint on 'UserLinks', fields ['user']
        db.create_unique('chat_userlinks', ['user_id'])
    ...
    models = {
        ...
        'chat.links': {
            ...
            'message': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['chat.Message']"}),
        ...
        'chat.notification': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'message_id': ('django.db.models.fields.CharField', [], {'max_length': '10', 'null': 'True', 'blank': 'True'}),
            'type': ('django.db.models.fields.CharField', [], {'max_length': '1'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"})
        },
        'chat.userlinks': {
            'Meta': {'object_name': 'UserLinks'},
            'favorite': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'link': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['chat.Links']"}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"})
        },
        'chat.userprofile': {
